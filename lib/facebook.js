...
Social.prototype.accounts = function(networkId, accessToken) {
  if (accessToken == null) {
    accessToken = networkId;
    networkId = 'me';
  }

  var path = constructPath(networkId, 'accounts')
    , parameters = { 
        fields: 'id,about,name,picture.width(300),link,access_token'
      , access_token: accessToken  
      };
